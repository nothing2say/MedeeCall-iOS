 ...
 *     @see `Sobel`, `Canny`
 */
- (void)detectEdges:(Mat*)_src _dst:(Mat*)_dst NS_SWIFT_NAME(detectEdges(_src:_dst:));
 ...
 */
- (void)computeOrientation:(Mat*)_src _dst:(Mat*)_dst NS_SWIFT_NAME(computeOrientation(_src:_dst:));
 ...
 */
- (void)edgesNms:(Mat*)edge_image orientation_image:(Mat*)orientation_image _dst:(Mat*)_dst r:(int)r s:(int)s m:(float)m isParallel:(BOOL)isParallel NS_SWIFT_NAME(edgesNms(edge_image:orientation_image:_dst:r:s:m:isParallel:));
 ...
 * @param m multiplier for conservative suppression.
 */
- (void)edgesNms:(Mat*)edge_image orientation_image:(Mat*)orientation_image _dst:(Mat*)_dst r:(int)r s:(int)s m:(float)m NS_SWIFT_NAME(edgesNms(edge_image:orientation_image:_dst:r:s:m:));
 ...
 * @param s radius for boundary suppression.
 */
- (void)edgesNms:(Mat*)edge_image orientation_image:(Mat*)orientation_image _dst:(Mat*)_dst r:(int)r s:(int)s NS_SWIFT_NAME(edgesNms(edge_image:orientation_image:_dst:r:s:));
 ...
 * @param r radius for NMS suppression.
 */
- (void)edgesNms:(Mat*)edge_image orientation_image:(Mat*)orientation_image _dst:(Mat*)_dst r:(int)r NS_SWIFT_NAME(edgesNms(edge_image:orientation_image:_dst:r:));
 ...
 * @param _dst suppressed image (grayscale, float, in [0;1])
 */
- (void)edgesNms:(Mat*)edge_image orientation_image:(Mat*)orientation_image _dst:(Mat*)_dst NS_SWIFT_NAME(edgesNms(edge_image:orientation_image:_dst:));
