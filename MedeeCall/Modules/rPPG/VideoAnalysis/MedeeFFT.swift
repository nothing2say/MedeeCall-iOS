...
class FFT {
    ...
    fileprivate func generateBandPassFilter(_ freqs: [Double]) -> ([Double], Int, Int) {
        let lowerFreq : Double = VideoSettings.getFilterStart()
        let higherFreq: Double = VideoSettings.getFilterEnd()
...
//        }
        ...
        return (retSpectrum, retSeries, maxFrequency, maxFrequencyResult.0)
//        // ----------------------------------------------------------------
